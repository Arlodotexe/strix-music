...
namespace StrixMusic.Helpers
{
    ...
    {
        /// <summary>
        /// A set of quips for a language and time.
        /// </summary>
        ...
        private static Dictionary<string, QuipGroup> holidayQuips = new Dictionary<string, QuipGroup>()
        {
            ...
            { "DrWhoAnniversary", new QuipGroup("DrWhoAnniversary", count:13, rule:new AnnualRangeRule(new DateTime(1, 7, 23), new DateTime(1, 7, 24)), weight:20) },
        };
