...
{
    [TestClass]
    public class RecentlyPlayedPluginBaseTests
    {
        ...
        internal class FullyCustom : RecentlyPlayedPluginBase
        {
            ...
            public override bool Equals(ICoreRecentlyPlayed? other) => throw AccessedException;
        }
        ...
        internal class Unimplemented : IRecentlyPlayed
        {
            ...
            public IReadOnlyList<ICoreRecentlyPlayed> Sources => throw AccessedException;
            public bool Equals(ICoreRecentlyPlayed? other) => throw AccessedException;
        }
    }
}
