...
namespace StrixMusic.Sdk.Services
{
    ...
    public interface ISharedFactory
    {
        ...
        SynchronizedObservableCollection<T> GetIncrementalCollection<T>(int take, Func<int, Task<List<T>>> loadMoreItems, Action onBatchStart, Action<List<T>> onBatchComplete);
