...
namespace StrixMusic.Sdk.Extensions
{
    ...
    public static class AbstractStorage
    {
        ...
        public async static Task<IList<IFileData>> RecursiveDepthFileSearchAsync(this IFolderData folder)
        {
        ...
        private async static Task<IList<IFileData>> RecursiveDepthFileSearchAsync(IFolderData folderData, IList<IFileData> fileDatas)
        {
