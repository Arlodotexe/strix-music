...
namespace StrixMusic.Sdk.AppModels
{
    ...
    public interface ITrackCollection : ITrackCollectionBase, IImageCollection, IUrlCollection, IPlayable, IAppModel, IMerged<ICoreTrackCollection>
    {
        ...
        /// <summary>
        /// Gets a requested number of <see cref="ITrack"/>s starting at the given offset.
        /// </summary>
        /// <param name="limit">The max number of items to return.</param>
        /// <param name="offset">Get items starting at this index.</param>
        /// <param name="cancellationToken">A cancellation token that may be used to cancel the ongoing task.</param>
        /// <returns>The requested range of items.</returns>
        IAsyncEnumerable<ITrack> GetTracksAsync(int limit, int offset, CancellationToken cancellationToken = default);
