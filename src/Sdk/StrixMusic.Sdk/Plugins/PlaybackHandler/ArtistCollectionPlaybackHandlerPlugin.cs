...
/// <summary>
/// Integrates an instance of <see cref="IPlaybackHandlerService"/> into all instances of <see cref="IArtistCollection"/>.
/// </summary>
internal class ArtistCollectionPlaybackHandlerPlugin : ArtistCollectionPluginBase
{
    ...
    /// <inheritdoc/>
    public override Task PlayArtistCollectionAsync() => _playbackHandler.PlayAsync(this, Inner);

    /// <inheritdoc/>
    public override Task PlayArtistCollectionAsync(IArtistCollectionItem artistItem) => _playbackHandler.PlayAsync(artistItem, this, Inner);
}
