...
namespace StrixMusic.Sdk.Data
{
    ...
    public interface IArtistCollection : IArtistCollectionBase, IArtistCollectionItem, ISdkMember
    {
        /// <summary>
        ...
        IAsyncEnumerable<IArtistCollectionItem> GetArtistItemsAsync(int limit, int offset);
