...
namespace StrixMusic.Sdk.Core.Data
{
    ...
    public interface IArtistCollection : IPlayableCollectionBase, IArtistCollectionItem
    {
        ...
        /// <summary>
        /// Checks if the backend supports removing an <see cref="ICoreArtist"/> at a specific index.
        /// </summary>
        ...
        /// <summary>
        /// Gets a requested number of <see cref="ICoreArtist"/>s starting at the given offset in the backend.
        /// </summary>
