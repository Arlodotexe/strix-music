...
namespace StrixMusic.Sdk.FileMetadataManagement.Scanners
{
    /// <summary>
    ...
    public sealed partial class PlaylistMetadataScanner : IDisposable
    {
        ...
        public Task<IEnumerable<PlaylistMetadata>> ScanPlaylists(IEnumerable<IFileData> files, IEnumerable<FileMetadata> fileMetadata)
        {
