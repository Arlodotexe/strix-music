...
public class ArtistCollectionPluginWrapper : IArtistCollection, IPluginWrapper
{
    ...
    /// <inheritdoc/>
    public Task<IReadOnlyList<IArtistCollectionItem>> GetArtistItemsAsync(int limit, int offset, CancellationToken cancellationToken = default) => _artistCollection.GetArtistItemsAsync(limit, offset, cancellationToken);
