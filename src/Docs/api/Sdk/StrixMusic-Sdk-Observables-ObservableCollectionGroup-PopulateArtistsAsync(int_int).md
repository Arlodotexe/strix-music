...
## ObservableCollectionGroup.PopulateArtistsAsync(int, int) Method
```csharp
public System.Threading.Tasks.Task<System.Collections.Generic.IReadOnlyList<StrixMusic.Sdk.Interfaces.IArtist>> PopulateArtistsAsync(int limit, int offset=0);
```
#### Parameters
<a name='StrixMusic-Sdk-Observables-ObservableCollectionGroup-PopulateArtistsAsync(int_int)-limit'></a>
`limit` [System.Int32](https://docs.microsoft.com/en-us/dotnet/api/System.Int32 'System.Int32')  
  
<a name='StrixMusic-Sdk-Observables-ObservableCollectionGroup-PopulateArtistsAsync(int_int)-offset'></a>
