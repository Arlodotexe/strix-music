...
## MergedSearchResults.ChangeNameAsync(string) Method
```csharp
public System.Threading.Tasks.Task ChangeNameAsync(string name);
```
#### Parameters
<a name='StrixMusic-Sdk-MergedWrappers-MergedSearchResults-ChangeNameAsync(string)-name'></a>
