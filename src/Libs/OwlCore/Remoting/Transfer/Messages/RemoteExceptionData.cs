...
namespace OwlCore.Remoting.Transfer
{
    ...
    /// </summary>
    public class RemoteExceptionDataMessage : IRemoteMessage
    {
        /// <summary>
        ...
        /// </summary>
        /// <remarks>
        /// Generated by <see cref="MemberRemote.CreateMemberSignature(MemberInfo)"/>.
        /// </remarks>
        public string? TargetSiteSignature { get; }

        /// <inheritdoc/>
        public RemotingAction Action { get; } = RemotingAction.ExceptionThrown;
