...
public abstract class SoundCloudPlayableCollectionGroupBase : ICorePlayableCollectionGroup
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="StorageCorePlayableCollectionGroupBase"/> class.
    /// </summary>
    /// <param name="sourceCore">The instance of the core this object was created in.</param>
    protected SoundCloudPlayableCollectionGroupBase(SoundCloudCore sourceCore)
    {
    ...
    /// <inheritdoc />
    public virtual IAsyncEnumerable<ICoreAlbumCollectionItem> GetAlbumItemsAsync(int limit, int offset, CancellationToken cancellationToken = default)
        => AsyncEnumerable.Empty<ICoreAlbumCollectionItem>();

    /// <inheritdoc />
    public virtual IAsyncEnumerable<ICoreArtistCollectionItem> GetArtistItemsAsync(int limit, int offset, CancellationToken cancellationToken = default)
        => AsyncEnumerable.Empty<ICoreArtistCollectionItem>();

    /// <inheritdoc />
    public virtual IAsyncEnumerable<ICorePlayableCollectionGroup> GetChildrenAsync(int limit, int offset, CancellationToken cancellationToken = default)
        => AsyncEnumerable.Empty<ICorePlayableCollectionGroup>();

    /// <inheritdoc />
    public virtual IAsyncEnumerable<ICorePlaylistCollectionItem> GetPlaylistItemsAsync(int limit, int offset, CancellationToken cancellationToken = default)
        => AsyncEnumerable.Empty<ICorePlaylistCollectionItem>();

    /// <inheritdoc />
    public virtual IAsyncEnumerable<ICoreTrack> GetTracksAsync(int limit, int offset, CancellationToken cancellationToken = default)
        => AsyncEnumerable.Empty<ICoreTrack>();

    /// <inheritdoc />
    public virtual IAsyncEnumerable<ICoreImage> GetImagesAsync(int limit, int offset, CancellationToken cancellationToken = default)
        => AsyncEnumerable.Empty<ICoreImage>();

    /// <inheritdoc />
    public virtual IAsyncEnumerable<ICoreUrl> GetUrlsAsync(int limit, int offset, CancellationToken cancellationToken = default)
        => AsyncEnumerable.Empty<ICoreUrl>();
