...
public abstract class StorageCorePlayableCollectionGroupBase : ICorePlayableCollectionGroup, IAsyncInit
{
    ...
    protected StorageCorePlayableCollectionGroupBase(ICore sourceCore)
    {
