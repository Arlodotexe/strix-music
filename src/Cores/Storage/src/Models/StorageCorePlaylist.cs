...
/// </summary>
public sealed class StorageCorePlaylist : ICorePlaylist
{
    private readonly FileMetadataManager? _fileMetadataManager;
    private PlaylistMetadata _playlistMetadata;

    /// <summary>
    /// Creates a new instance of <see cref="StorageCorePlaylist"/>
    /// </summary>
    public StorageCorePlaylist(ICore sourceCore, PlaylistMetadata playlistMetadata)
    {
