...
namespace StrixMusic.Core.External.Models
{
    ...
    public class ExternalCorePlaylist : ICorePlaylist
    {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="ExternalCorePlaylist"/>
        /// </summary>
        public ExternalCorePlaylist(ICore sourceCore, PlaylistMetadata playlistMetadata)
        {
        ...
        public async IAsyncEnumerable<ICoreTrack> GetTracksAsync(int limit, int offset)
        {
            ...
            {
                yield return new ExternalCoreTrack(SourceCore, item);
            }
        }
