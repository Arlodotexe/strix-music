...
namespace StrixMusic.Shells.ZuneDesktop.Controls.Views.Collection
{
    ...
    public partial class ZuneAlbumCollection : CollectionControl<ZuneAlbumCollectionItem, ZuneAlbumItem>
    {
        ...
        public static readonly DependencyProperty ZuneCollectionTypeProperty =
            DependencyProperty.Register(nameof(ZuneCollectionType), typeof(CollectionContentType), typeof(ZuneAlbumCollection), new PropertyMetadata(CollectionContentType.Albums, null));
        ...
        public static readonly DependencyProperty SortStateProperty =
            DependencyProperty.Register(nameof(SortState), typeof(ZuneSortState), typeof(ZuneAlbumCollection), new PropertyMetadata(ZuneSortState.AZ, null));
