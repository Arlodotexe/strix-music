...
#### Check out our [docs](../docs) to get started
...
In short, a model plugin modifies data or behavior for any [AppModel](../docs/reference/api/StrixMusic.Sdk.AppModels.html) in the SDK by wrapping around it and selectively overriding members, then taking the place of the original model.
